        ...
        >
          {HOW_IT_WORKS.map((step) => (
            <motion.div
              ...
              className="group rounded-2xl border border-app-border bg-app-surface p-6 transition-[border-color,box-shadow] duration-200 hover:border-app-accent/60 hover:shadow-[0_8px_30px_-4px_rgba(164,214,24,0.35)]"
            >
              <span className="text-3xl font-black text-app-accent transition-[filter] duration-200 group-hover:[filter:brightness(1.4)_drop-shadow(0_0_14px_rgba(164,214,24,0.85))]">
                {step.number}
              </span>
